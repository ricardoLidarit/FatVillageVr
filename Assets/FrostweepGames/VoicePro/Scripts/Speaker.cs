...
namespace FrostweepGames.VoicePro
{
    ...
    {
        public event System.Action SpeakerTalkStartedEvent;

        public event System.Action SpeakerTalkEndedEvent;
            ...
            try
            {
                ...
                if (!Playing)
                {
                    if (_audioClipReadyToUse)
                    {
                        ...
                        SpeakerTalkStartedEvent?.Invoke();
                    }
